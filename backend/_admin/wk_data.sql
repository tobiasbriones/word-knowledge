...
INSERT INTO `cat_1` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'fun', 'divertido', 'Adjectives'),
...
INSERT INTO `cat_2` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'juice', 'jugo', 'Beverages'),
...
INSERT INTO `cat_3` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'allergy', 'alergia', 'Health problems'),
...
INSERT INTO `cat_4` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'cat', 'gato', 'Fauna'),
(2, 'dog', 'perro', 'Fauna'),
...
INSERT INTO `cat_5` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'cover', 'portada', 'The book'),
...
INSERT INTO `cat_6` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'head', 'cabeza', 'Body parts'),
...
INSERT INTO `cat_7` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'garden', 'jardín', 'At home'),
...
INSERT INTO `cat_8` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'food processor', 'procesador de comida', 'Appliances'),
...
INSERT INTO `cat_9` (`id`, `english`, `spanish`, `subcategory`) VALUES
(1, 'wire', 'alambre', 'Electricity & Electronic'),
...
INSERT INTO `reg` (`id`, `name`, `subcategories`) VALUES
(1, 'About grammar', '[\"Adjectives\",\"Adverbs\",\"Irregular verbs (Participle)\",\"Irregular verbs (Past)\",\"Verbs\"]'),
(2, 'Foods & Meals', '[\"Beverages\",\"Dairy products\",\"Fish & Seafood\",\"Fruits\",\"Healthy & Unhealthy\",\"Herbs\",\"Meats & Seasoning\",\"Pasta\",\"Soups\",\"Sweets & Desserts\",\"Vegetables\"]'),
(3, 'Miscellaneous', '[\"Cardinal numbers\",\"Colors\",\"Health problems\",\"Not rated\",\"Ordinal numbers\",\"Transportation\"]'),
(4, 'Nature', '[\"Fauna\",\"Flora\",\"Habitats\",\"Natural phenomena\",\"The universe\",\"The weather & Seasons\"]'),
(5, 'Parts of things', '[\"The bicycle\",\"The book\",\"The car\",\"The cell phone\",\"The computer\",\"The ship\"]'),
(6, 'People', '[\"Activities\",\"Body parts\",\"Chores\",\"Clothing\",\"Family & Relatives\",\"Moods\",\"Physical defects\",\"Politics\",\"Professions\",\"Society\",\"The look\"]'),
(7, 'Places', '[\"At home\",\"At the airport\",\"At the bank\",\"At the bar\",\"At the beach\",\"At the beauty salon\",\"At the bookstore\",\"At the downtown\",\"At the drugstore\",\"At the gym\",\"At the hardware store\",\"At the hotel\",\"At the mall\",\"At the restaurant\",\"At the school\",\"At the supermarket\",\"At the workplace\"]'),
(8, 'Products & Things', '[\"Appliances\",\"Containers\",\"Electronic\",\"Everyday products\",\"Furniture\",\"Materials\",\"Music\"]'),
(9, 'Technicalities & Tools', '[\"Business & Sales\",\"Electricity & Electronic\",\"Farm machinery\",\"Law\",\"Math & Physics\",\"Mechanics\",\"Science\"]');
...
ALTER TABLE `cat_1`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_1` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_2`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_2` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_3`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_3` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_4`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_4` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_5`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_5` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_6`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_6` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_7`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_7` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_8`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_8` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
ALTER TABLE `cat_9`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `cat_9` ADD FULLTEXT KEY `english` (`english`,`spanish`);
...
--
ALTER TABLE `cat_6`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
